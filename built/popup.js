...
/***/ function(module, exports, __webpack_require__) {
	...
	const not_found_1 = __webpack_require__(19);
	const settings_1 = __webpack_require__(20);
	const tasks_1 = __webpack_require__(61);
	const Popup = React.createClass({
	    ...
	    render() {
	        return (React.createElement("div", null, React.createElement(header_1.Header, {title: this.title(), links: this.headerLinks()}), React.createElement("div", {className: "main-container"}, React.createElement("main", {className: "wrapper clearfix"}, this.props.children)), React.createElement("div", {className: "footer-container"}, React.createElement("footer", {className: "wrapper"}, React.createElement("span", {style: { 'float': 'left' }}, this.footerLinks().map((link) => (React.createElement(react_router_1.Link, {key: link.to, to: link.to}, link.title)))), React.createElement("div", {className: "right"}, this.title(), " © 2016")))));
	    }
	});
	// <aside>
	// 	<h3>aside</h3>
	...
	// </aside>
	//
	ReactDOM.render((React.createElement(react_router_1.Router, {history: react_router_1.hashHistory}, React.createElement(react_router_1.Route, {path: "/", component: Popup}, React.createElement(react_router_1.IndexRoute, {component: tasks_1.TasksPage}), React.createElement(react_router_1.Route, {path: "tasks", component: tasks_1.TasksPage}), React.createElement(react_router_1.Route, {path: "settings", component: settings_1.SettingsPage}), React.createElement(react_router_1.Route, {path: "*", component: not_found_1.NotFoundPage})))), document.querySelector('#app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Header = React.createClass({
	    render() {
	        return (React.createElement("div", {className: "header-container"}, React.createElement("header", {className: "wrapper clearfix"}, React.createElement("h1", {className: "title"}, this.props.title), React.createElement(menu_1.Menu, {links: this.props.links}))));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Menu = React.createClass({
	    render() {
	        return (React.createElement("nav", null, React.createElement("ul", null, this.props.links.map((link) => (React.createElement("li", {key: link.to}, React.createElement(react_router_1.Link, {to: link.to}, link.title)))))));
	    }
	});
	exports.Menu = Menu;
...
/***/ function(module, exports, __webpack_require__) {
	...
	const NotFoundPage = React.createClass({
	    render() {
	        return (React.createElement("div", null, "Страница не найдена. Вернуться на ", React.createElement(react_router_1.Link, {to: '/'}, "главную"), "?"));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(14);
	const filters_pane_1 = __webpack_require__(21);
	const notifications_pane_1 = __webpack_require__(60);
	const extension_config_1 = __webpack_require__(9);
	const SettingsPage = React.createClass({
	    config() {
	        return new extension_config_1.ExtensionConfig();
	    },
	    render() {
	        return (React.createElement("div", null, React.createElement("div", {className: "settings-pane"}, React.createElement("h4", null, "Filters:"), React.createElement(filters_pane_1.FiltersPane, {config: this.config()})), React.createElement("div", {className: "settings-pane"}, React.createElement("h4", null, "Notifications:"), React.createElement(notifications_pane_1.NotificationsPane, {config: this.config()}))));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(14);
	const selectors_1 = __webpack_require__(22);
	const toloka_selectors_1 = __webpack_require__(23);
	const filter_pane_1 = __webpack_require__(24);
	const selectors_manager_1 = __webpack_require__(59);
	const FiltersPane = React.createClass({
	    getInitialState() {
	        return {
	    ...
	    selectors() {
	        return new selectors_manager_1.SelectorsManager(new selectors_1.Selectors([
	            new toloka_selectors_1.TitleSelector('title', () => {
	                return [
	            ...
	            new toloka_selectors_1.RequesterSelector('requester', () => {
	                return [
	                    { name: { RU: 'Я.Единорог' } },
	                    { name: { RU: 'Я.Водолей' } },
	                    { name: { RU: 'Я.Орион' } },
	    ...
	    render() {
	        return (React.createElement("div", {className: "filters-pane"}, React.createElement("div", null, this.state.filters.map((action, filterIdx) => (React.createElement("div", {key: filterIdx, className: "action-pane"}, React.createElement(filter_pane_1.FilterPane, {selectors: this.selectors(), filter: action.filter}), React.createElement("div", {className: "action"}, "Action:", this.actions().map((option, i) => (React.createElement("label", {key: option.id}, React.createElement("div", null, (action.action !== undefined)
	            ? (React.createElement("input", {type: "radio", name: 'action' + filterIdx, value: option.id, checked: action.action === option.id}))
	            : (React.createElement("input", {type: "radio", name: 'action' + filterIdx, value: option.id, defaultChecked: !i})), option.title))))))))), React.createElement("div", {className: "adder"}, React.createElement("a", {onClick: this.addFilter}, "[+]"))));
	    },
	});
	exports.FiltersPane = FiltersPane;
	//# sourceMappingURL=filters-pane.js.map
...
/***/ function(module, exports) {
	...
	class CompoundMatcher extends Matcher {
	    ...
	    add(matcher) {
	        this.incapsulated[this.uid] = matcher;
	        return this.uid++;
	    }
	    remove(id) {
	        if (this.incapsulated[id])
	            delete this.incapsulated[id];
	    }
	    any(item) {
	        for (let id in this.incapsulated)
	            if (this.incapsulated[id].match(item))
	                return true;
	        return false;
	    }
	    some(item) {
	    ...
	    map(mapper) {
	        let result = [];
	        for (let id in this.incapsulated)
	            result.push(mapper(this.incapsulated[id], +id));
	        return result;
	    }
	}
	class Selector extends Matcher {
	...
	class SelectorGroup extends CompoundMatcher {
	    match(item) {
	        return !this.some(item);
	    }
	}
	exports.SelectorGroup = SelectorGroup;
	class Filter extends CompoundMatcher {
	    match(item) {
	...
	exports.FilteredAction = FilteredAction;
	class Selectors {
	    ...
	    map(mapper) {
	        let result = [];
	        for (let type in this.selectors)
	            result.push(mapper(this.selectors[type], type));
	        return result;
	    }
	}
...
/***/ function(module, exports) {
	...
	"use strict";
	class Suggestable {
	    constructor(type, fetcher, value) {
	        this.type = type;
	    ...
	    suggestions(match) {
	        ...
	        if (inputLength !== 0) {
	            ...
	            return this.all.filter(suggestion => {
	                return this
	...
	class TitleSelector extends Suggestable {
	    constructor(type, fetcher, value) {
	        super(type, fetcher, value);
	    }
	    comparable(suggestion) {
	        return suggestion.tec.title;
	    }
	    uid(suggestion) {
	        return suggestion.tec.pollId;
	    }
	}
	exports.TitleSelector = TitleSelector;
	class RequesterSelector extends Suggestable {
	    constructor(type, fetcher, value) {
	        super(type, fetcher, value);
	    }
	    comparable(suggestion) {
	        return suggestion.name.RU;
	    }
	    uid(suggestion) {
	        return suggestion.id;
	    }
	}
	exports.RequesterSelector = RequesterSelector;
	//# sourceMappingURL=toloka-selectors.js.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(14);
	const group_pane_1 = __webpack_require__(25);
	const FilterPane = React.createClass({
	    getInitialState() {
	        return {
	    ...
	    addGroup() {
	        this.state.filter.add(this.props.selectors.addGroup());
	        this.setState({
	            filter: this.state.filter,
	        });
	    },
	    render() {
	        return (React.createElement("div", {className: "filter-pane"}, React.createElement("div", {className: "groups"}, this.state.filter.map((group, i) => {
	            return (React.createElement(group_pane_1.GroupPane, {key: i, selectors: this.props.selectors, group: group}));
	        })), React.createElement("div", {className: "adder"}, React.createElement("a", {onClick: this.addGroup}, "+"))));
	    },
	});
	exports.FilterPane = FilterPane;
	//# sourceMappingURL=filter-pane.js.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(14);
	const selector_pane_1 = __webpack_require__(26);
	const GroupPane = React.createClass({
	    getInitialState() {
	        return {
	    ...
	    addSelector() {
	        this.state.group.add(this.props.selectors.addSelector());
	        this.setState({
	            group: this.state.group,
	        });
	    },
	    render() {
	        return (React.createElement("div", {className: "group-pane"}, React.createElement("div", {className: "selectors"}, this.state.group.map((selector, i) => {
	            return (React.createElement(selector_pane_1.SelectorPane, {key: i, selectors: this.props.selectors, selector: selector}));
	        })), React.createElement("div", {className: "adder"}, React.createElement("a", {onClick: this.addSelector}, "+"))));
	    },
	});
	exports.GroupPane = GroupPane;
	//# sourceMappingURL=group-pane.js.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(14);
	const autosuggest_1 = __webpack_require__(27);
	const SelectorPane = React.createClass({
	    getInitialState() {
	        return {
	    ...
	    fetchSuggestions(input) {
	        let selector = this.props.selectors.suggestions.get(this.state.type);
	        return selector
	    ...
	    render() {
	        ...
	        let selector = this.props.selectors.suggestions.get(type);
	        return (React.createElement("div", {className: "selector-pane"}, React.createElement("select", {value: type, onChange: this.pickType}, this.props.selectors.suggestions.map((selector, i) => {
	            return React.createElement("option", {key: i, value: selector.type}, selector.getLabel());
	        })), selector
	            ? React.createElement("div", null, " → ", React.createElement(autosuggest_1.Autosuggest, {value: value, placeholder: selector.name, renderSuggestion: (suggestion) => selector.comparable(suggestion), fetchSuggestions: this.fetchSuggestions, getSuggestionValue: (suggestion) => selector.comparable(suggestion), onValueChanged: this.onValueChanged}))
	            : null));
	    }
	});
	exports.SelectorPane = SelectorPane;
	//# sourceMappingURL=selector-pane.js.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(14);
	const Autosuggest = __webpack_require__(28);
	const Autosuggestable = React.createClass({
	    getInitialState() {
	    ...
	    onChange(event, { newValue }) {
	        ...
	        if (this.props.onValueChanged)
	            this.props.onValueChanged(newValue, this.getSuggestions(newValue)[0]);
	    },
	    ...
	    render() {
	        const exclude = [
	            'value', 'placeholder', 'fetchSuggestions', 'onValueChanged'
	        ];
	        let pass = {};
	        for (let prop in this.props)
	            if (exclude.indexOf(prop) < 0)
	                pass[prop] = this.props[prop];
	        ...
	        return (React.createElement(Autosuggest, __assign({suggestions: suggestions, onSuggestionsUpdateRequested: this.onSuggestionsUpdateRequested, inputProps: inputProps}, pass)));
	    }
	});
	exports.Autosuggest = Autosuggestable;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerAndActions = __webpack_require__(44);

	var _reducerAndActions2 = _interopRequireDefault(_reducerAndActions);

	var _Autosuggest = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAutowhatever = __webpack_require__(55);
...
/***/ function(module, exports, __webpack_require__) {
	...
	class SelectorsManager {
	    constructor(suggestions) {
	        ...
	        this.def = suggestions.names()[0];
	    }
	    addSelector(type = this.def) {
	        return this.suggestions.get(type);
	    }
	    addGroup() {
	        return new selectors_1.SelectorGroup([
	            this.addSelector()
	        ]);
	    }
	    addFilter() {
	        return new selectors_1.Filter([
	            this.addGroup()
	        ]);
	    }
	    addAction() {
	        return new selectors_1.FilteredAction(this.addFilter());
	    }
	}
	exports.SelectorsManager = SelectorsManager;
	//# sourceMappingURL=selectors-manager.js.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(14);
	const NotificationsPane = React.createClass({
	    getInitialState() {
	        return {
	    ...
	    render() {
	        return (React.createElement("div", {className: "notifications-pane"}, React.createElement("div", null, React.createElement("label", null, "Sound:", React.createElement("input", {value: this.state.sound, onChange: this.changeSound}))), React.createElement("div", null, React.createElement("label", null, "Volume: ", React.createElement("output", null, ~~(this.state.volume * 100)), React.createElement("input", {type: "range", id: "volume", min: "0", max: "1", step: "0.01", value: this.state.volume, onChange: this.changeVolume})))));
	    },
	});
	exports.NotificationsPane = NotificationsPane;
	//# sourceMappingURL=notifications-pane.js.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(14);
	const fetcher_1 = __webpack_require__(62);
	let TaskItem = React.createClass({
	    render() {
	        return (React.createElement("div", {className: "task"}, React.createElement("span", {className: "title"}, this.props.task.title), React.createElement("span", {className: "requester"}, this.props.task.requester)));
	    }
	});
	const TasksList = React.createClass({
	    render() {
	        return (React.createElement("div", null, React.createElement("ul", null, React.createElement("li", null, this.props.tasks.map((task) => (React.createElement(TaskItem, {key: task.uid, task: task}))))), React.createElement("div", {className: "error"}, this.props.error)));
	    }
	});
	const TasksPage = React.createClass({
	    getInitialState() {
	        return {
	            tasks: [],
	            fetcher: new fetcher_1.TaskFetcher((tasks) => {
	                if (tasks)
	    ...
	    componentWillUnmount() {
	        this.state.fetcher.disconnect();
	    },
	    fetchTasks() {
	        this.state.fetcher.requestConnect();
	        this.state.fetcher.fetch();
	    },
	    render() {
	        return (React.createElement(TasksList, {tasks: this.state.tasks}));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	class TaskFetcher extends port_1.ClientPort {
	    ...
	    requestConnect() {
	        return actions_1.Actions.connect(this);
	    }
	    process(action, data) {
	        if (action === actions_1.Actions.TASKS) {
	            let wrapped = [];
	            for (let item of data)
	                wrapped.push(new task_wrapper_1.TaskWrapper(item));
	            for (let listener of this.listeners)
	                listener(wrapped);
	        }
	    }
	    fetch() {
	        return actions_1.Actions.tasks(this);
	    }
	}
	exports.TaskFetcher = TaskFetcher;
